...
public MbrpfVO addMbrpf(String mbract, String mbrpw, String mbrname, byte[] mbrimg,Date birth,
			Integer sex, String mail, String phone, String mbrac, String nickname,Integer points,
...
public MbrpfVO updateMbrpf(String mbrno,String mbract, String mbrpw, String mbrname, byte[] mbrimg, java.sql.Date birth,
			Integer sex, String mail, String phone, String mbrac, String nickname,Integer points,
			Integer status, Integer ratedtotal, Integer startotal, Integer unattend, Integer ttattend
			) {
