				...
				<div class="col-12">
					...
					<div class="float-right">
						...
						<c:if test="${empty account}">
							<a href="<%=request.getContextPath()%>/front-end/shop/login.jsp" class="text-white"> 
									<span class="d-md-inline-block">
								<img class="icon" src="<%=request.getContextPath()%>/front-end/images/man-icon.png">店家登入</span>
							</a>
						</c:if>
					</div>
				</div>
		...
		<div class="container">
			<div class="row align-items-center position-relative">
				...
				<div class="site-logo">
					...
					<span class="text-primary">Gameing on Board</span></a>
				</div>
